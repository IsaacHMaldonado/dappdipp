<template>
    <div>
        ...
        <inertia-link :href="href" class="block px-4 py-2 text-sm font-medium leading-5 text-SSAred-400 hover:bg-gray-100 hover:text-SSAgreen-500 hover:font-semibold focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" v-else>
            <slot></slot>
        </inertia-link>
    </div>
</template>
